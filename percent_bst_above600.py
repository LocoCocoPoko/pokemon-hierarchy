...
plt.title("Legendary and Regular Pokémon Above 600 BST", fontsize=18, fontweight='bold', pad=20)
plt.ylabel("Percentage of Pokémon Above 600 BST", fontsize=14, labelpad=15)
...
# Save and Show
plt.tight_layout()
plt.savefig('pct_above_600_bst.png', dpi=300)
plt.show()